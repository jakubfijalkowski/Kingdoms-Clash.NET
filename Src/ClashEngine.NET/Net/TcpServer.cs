...
namespace ClashEngine.NET.Net
{
	...
	//    /// <param name="gameName"><see cref="Name"/></param>
	//    /// <param name="gameVersion"><see cref="Version"/></param>
	...
	//                    {
	//                        if ((client as Internals.ServerClient).WelcomeMessage.Value.Version == this.Version)
	//                        {
